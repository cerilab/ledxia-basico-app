...
import { ReceiptPreview } from "./invoice";
...
export function TemplateClient() {
    ...
    useEffect(() => {
        ...
        const u1 = subscribePrintTemplate(tenantId, (tpl) => {
            if (tpl) {
                ...
                // Si en base de datos ya está guardado como A4, abrimos esa pestaña por defecto
                if (currentWidth === "A4") {
                    setActiveTab("a4");
                }
            }
    ...
    // Al cambiar de pestaña, forzamos el cambio del tamaño de papel correspondiente
    const handleTabChange = (value: string) => {
        ...
        if (tab === "a4") {
            ...
            set("paperWidth", "80mm"); // Valor por defecto al regresar a ticketera
        }
    };
    ...
    // Configuración común de los campos del formulario para no repetir código HTML
        ...
        <div className="space-y-6">
            ...
            {activeTab === "a4" && (
                <div className="grid gap-6 xl:grid-cols-[1fr_auto]">
                    ...
                    {/* Vista Previa Completa en A4 (Diseño tipo Hoja) */}
