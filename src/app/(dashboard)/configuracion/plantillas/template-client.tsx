...
export function TemplateClient() {
    ...
    // Función para invocar el diálogo de impresión nativo del sistema
    const handlePrint = () => {
        window.print();
    };
    ...
    return (
        <div className="space-y-6">
            {/* Ocultamos los textos del panel principal al imprimir */}
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_auto]">
                {/* Editor - Oculto completamente al imprimir */}
                ...
                {/* En pantalla se ve dentro de su caja gris, en impresión ocupa toda la hoja de la ticketera */}
